...
const TESTIMONIALS = [
  {
    ...
    quote:
      "Avant je galérais entre 6 logiciels. Maintenant 1 prompt suffit pour un drama complet.",
  ...
  },
  {
    handle: "@dr.skelix",
    quote:
      "Mes personnages restent cohérents d'épisode en épisode. Le style Pixar est fou.",
  ...
  },
  {
    handle: "@hamuyama_lab",
    quote:
      "Golden hour, émotions max — exactement le rendu viral que je cherchais.",
    ...
    <section className="bg-bg-secondary py-20">
      <div className="mx-auto max-w-6xl px-4">
        <h2 className="mb-10 text-center text-3xl font-extrabold">
          Ils cartonnent avec{" "}
          <span className="text-gradient">FruitDrama</span>
        </h2>
